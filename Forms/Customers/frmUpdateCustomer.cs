...
namespace CRUD_Assignment.Forms.Customers
{
    public partial class frmUpdateCustomer : Form
    {
        ...
        private void frmUpdateCustomer_Load(object sender, EventArgs e)
        {
            ...
            dateBirthday.Value = val.CustomerBirthday.Date;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (customer.UpdateCustomer(val.CustomerId, txtFirstName.Text, txtMiddleName.Text, txtLastName.Text, cmbGender.Text, age,
